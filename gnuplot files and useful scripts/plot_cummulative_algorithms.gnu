...
set output "./graphs/cummulative_25_0.18.png"
plot    "./results/cummulative_output_25_0.18_UCB" using (10**($0+1)):1 title 'UCB' with linespoints, \
		"./results/cummulative_output_25_0.18_BETA-UCB" using (10**($0+1)):1 title 'BETA-UCB' with linespoints, \
		"./results/cummulative_output_25_0.18_ADAPTIVE-BETA-UCB" using (10**($0+1)):1 title 'ADAPTIVE-BETA-UCB' with linespoints, \
		"./results/cummulative_output_25_0.18_UCB-TUNED" using (10**($0+1)):1 title 'UCB-TUNED' with linespoints